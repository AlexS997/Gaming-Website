...
const Arena = () => {
  return (
    <section className="md:min-h-[90%] p-0 lg:p-8 md:mt-0 bg-gradient-to-t from-black to-[#1d1f3e]">
            ...
            <div className="md:col-span-1 space-y-4 md:space-y-6">
                <div className="relative overflow-hidden rounded-3xl border border-white aspect-[4.4/4] transform transition-transform duration-300 hover:scale-105">
                    <div className="absolute h-full w-full">
                        <img src="../src/assets/images/bento-card1.png" alt="b1Img" />

                        <button className='absolute bottom-0 h-16 w-full bg-black/70 text-xl font-bold hover:text-yellow-400 transition-all duration-300 text-nowrap cursor-pointer'>
                ...
                <div className='relative overflow-hidden rounded-3xl border border-white aspect-[4.5/4] transform transition-transform duration-300 hover:scale-105'>
                    <video src="../src/assets/videos/bento-card2.mp4"
            ...
            <div className="md:col-span-2 space-y-4 md:space-y-6">
                    <div className='grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6'>
                        <div className='relative overflow-hidden rounded-3xl border border-white aspect-square transform transition-transform duration-300 hover:scale-105'>
                            <video src="../src/assets/videos/bento-card3.mp4"
                                className='w-full h-full object-cover'
                                autoPlay
                                loop
                                muted
                        ...
                        <div className='relative overflow-hidden rounded-3xl border border-white aspect-square transform transition-transform duration-300 hover:scale-105'>
                            <video src="../src/assets/videos/bento-card4.mp4"
                                className='w-full h-full object-cover'
                                autoPlay
                                loop
                                muted
                        ...
                        <div className='relative overflow-hidden rounded-3xl border border-white aspect-square transform transition-transform duration-300 hover:scale-105'>
                            <video src="../src/assets/videos/bento-card5.mp4"
                                className='w-full h-full object-cover'
                                autoPlay
                                loop
                                muted
                    ...
                    <div className='relative overflow-hidden rounded-3xl border border-white sapect-[16/9] md:col-span-2 transform transition-transform duration-300 hover:scale-[1.02]'>
                        <img src="../src/assets/images/bento-card5.png" alt="b5Img" />

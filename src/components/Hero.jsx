import Video from '/src/assets/videos/hero.mp4'
import Img1 from '/src/assets/images/illu-text.png'
import Img2 from '/src/assets/images/illu-logo.png'
  ...
  return (
    <main className="relative w-full h-screen overflow-hidden flex justify-center mb-[10%]">
        ...
        <div className='absolute bottom-[15%] flex flex-col items-center gap-5'>
            ...
            <button className='h-10 px-16 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-lg font-medium text-nowrap hover:opacity-70 transition-all duration-300 cursor-pointer'>
                PLAY NOW
            </button>
